<template>
    <div idm-ctrl="idm_module" :id="moduleObject.id" :idm-ctrl-id="moduleObject.id">
        <div class="IDatePicker_app" :class="propData.radioDirection == 'horizontal' ? 'flex_start' : ''">
            <div v-if="propData.showLabel" class="label">{{ propData.label }}</div>
            <div class="date_box">
                <el-date-picker v-model="value" @change="onChange" :type="propData.showType" :size="propData.size" :format="propData.format" :valueFormat="propData.valueFormat" :clearable="propData.clearable" placeholder="选择日期">
                </el-date-picker>
            </div>
        </div>
    </div>
    ...
    methods: {
        ...
        convertThemeListAttrToStyleObject() {
            ...
            for (var i = 0; i < themeList.length; i++) {
                ...
                IDM.setStyleToPageHead( "." + themeNamePrefix + item.key + " #" + (this.moduleObject.packageid || "module_demo") + " .el-input__icon", fontObject );
                IDM.setStyleToPageHead( "." + themeNamePrefix + item.key + " #" + (this.moduleObject.packageid || "module_demo") + " .el-input__inner", borderObject );
                IDM.setStyleToPageHead( "." + themeNamePrefix + item.key + " #" + (this.moduleObject.packageid || "module_demo") + " .el-input__inner:hover", borderObject );
                IDM.setStyleToPageHead( "." + themeNamePrefix + item.key + " #" + (this.moduleObject.packageid || "module_demo") + " .el-input__inner:focus", borderObject );
                IDM.setStyleToPageHead( "." + themeNamePrefix + item.key + " #" + (this.moduleObject.packageid || "module_demo") + " .el-input.is-active .el-input__inner", borderObject );
            }
        },
        /** * 把属性转换成样式对象 */
